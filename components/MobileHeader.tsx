...
export default function MobileHeader() {
  ...
  return (
    <div className="flex pt-10 sm:block md:hidden">
      <Link href="/">
      ...
      <motion.div
        ...
        <div className="relative z-30 m-auto w-9/12 pt-10">
          <div className="relative h-12 w-40">
            <Image
          ...
          <div className="flex flex-col pt-12 text-5xl text-primary-light">
            <ul>
              <Link href="/">
                <li className="inline-flex flex-col mb-8">
                  ...
                  <motion.div
                    ...
                    className="inline border-b-4 pt-1"></motion.div>
                </li>
              </Link>
